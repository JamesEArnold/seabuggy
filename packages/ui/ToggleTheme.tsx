  ...
  return (
    <>
      ...
      <label
        ...
        className="w-10 h-6 rounded-full border-2 border-solid peer-checked:border-sea-sky-800 flex relative transition-all peer-checked:bg-sea-sky-400 bg-sea-foam-blue-400 border-sea-foam-blue-700
